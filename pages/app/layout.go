						...
						Div(InlineStyle("me{display: flex; height: $(16); align-items: center; justify-content: space-between;}"),
							Div(InlineStyle("me{align-items: center; display: flex;}"),
								...
								Div(InlineStyle("@media lg-{ this{display: block;}}"),
									Div(InlineStyle(`me{margin-left: $(10); display: flex; align-items: baseline;} $this:not(:last-child){ margin-left: $(4); }`),
							...
							Div(InlineStyle("me{display: none;} @media md { this{ display: block; }}"),
								Div(InlineStyle("me{ margin-left: $(4); display: flex; align-items: center;} @media md { this{ margin-left: $(6) }}"),
