				...
				Nav(Class("bg-neutral-800"),
						...
						Div(Class("flex h-16 items-center justify-between"),
							Div(Class("flex items-center"),
								Div(Class("flex-shrink-0"),
									A(Href(pageinfo.INDEX.Url), Img(Class("h-12 w-12"), Src("/images/logo.svg"), Alt("Previous"))),
								),
								Div(Attr("x-data", "{ examplesDropdownOpen: false }"), Class("hidden md:block"),
									Div(Class("ml-10 flex items-baseline space-x-4"),
										A(Href(pageinfo.APP_DASHBOARD.Url), Class("px-3 py-2 text-sm font-medium text-neutral-100 hover:text-white"), Text("Dashboard")),
										A(Href(pageinfo.APP_SITEMAP.Url), Class("px-3 py-2 text-sm font-medium text-neutral-100 hover:text-white"), Text("Sitemap")),
										Div(Class("relative ml-3"),
											...
											Div(Attr("x-cloak"), Attr("x-show", "examplesDropdownOpen"), Class("absolute right-0 z-10 mt-2 w-48 origin-top-right bg-white py-1 shadow-lg ring-1 ring-black/50 focus:outline-none"), TabIndex("-1"),
												...
												A(Href(pageinfo.APP_EXAMPLES_SERVERSIDEDATAGRID.Url), Class("block px-4 py-2 text-sm text-neutral-700 hover:bg-neutral-100"), TabIndex("-1"), Text("Server-Side Data Grid")),
												...
												A(Href(pageinfo.APP_EXAMPLES_APIFETCH.Url), Class("block px-4 py-2 text-sm text-neutral-700 hover:bg-neutral-100"), TabIndex("-1"), Text("Server-side API Fetch")),
											),
										),
										A(Href(pageinfo.APP_APIDEMO.Url), Class("px-3 py-2 text-sm font-medium text-neutral-100 hover:text-white"), Text("API Demo")),
							...
							Div(Class("hidden md:block"),
								Div(Class("ml-4 flex items-center md:ml-6"),
									Div(Class("relative ml-3"),
										Div(
											Button(Attr("x-on:click", "profileDropdownOpen = !profileDropdownOpen"), Attr("x-on:click.outside", "profileDropdownOpen = false"), Type("button"), Class("relative flex max-w-xs items-center bg-neutral-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-neutral-800"),
					...
					Div(Attr("x-show", "mobileMenuOpen"), Attr("x-on:click.outside", "mobileMenuOpen = false"), Attr("x-cloak"), Class("md:hidden"),
						Div(Class("space-y-1 px-2 pb-3 pt-2 sm:px-3"),
							A(Href(pageinfo.APP_DASHBOARD.Url), Class("block hover:bg-neutral-900 px-3 py-2 text-base font-medium text-white"), Text("Dashboard")),
						),
						Div(Class("border-t border-neutral-700 pb-3 pt-4"),
							...
							Div(Class("mt-3 space-y-1 px-2"),
								A(Href(pageinfo.APP_ACCOUNT.Url), Class("block px-3 py-2 text-base font-medium text-neutral-200 hover:bg-neutral-900 hover:text-white"), Text("Your Profile")),
								A(Href(pageinfo.AUTH_LOGOUT.Url), Class("block px-3 py-2 text-base font-medium text-neutral-200 hover:bg-neutral-900 hover:text-white"), Text("Log out")),
							),
						),
					),
				),
