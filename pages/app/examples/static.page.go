			...
			IfElse(this.IsStatic(),
				Group{
					...
					P(
						...
						Pre(InlineStyle("this{ color: var(--color-pink-600); }"), Raw("// @Static")),
						Text(" to see the page in dynamic mode."),
					),
					Br(),
					P(
						InlineStyle("this{color: red;}"),
					...
					Div(InlineStyle("this{margin-top: $(10); padding: $(10); background: var(--color-white); border: 1px solid var(--color-neutral-200); box-shadow: var(--shadow-md);}"),
						P(InlineStyle("this{font-weight: var(--font-weight-bold); color: var(--color-red-600);}"), Text("IMPORTANT")),
						P(
