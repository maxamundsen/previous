			...
			Div(Attr("x-data", "{ profileDropdownOpen: false, mobileMenuOpen: false }"), Class("min-h-full"),
				Nav(Class("bg-gray-800"),
						...
						Div(Class("flex h-16 items-center justify-between"),
							Div(Class("flex items-center"),
								Div(Class("flex-shrink-0"),
									A(Href("/"), Img(Class("h-16 w-16"), Src("/images/logo_white.svg"), Alt("Saral"))),
								),
								Div(Attr("x-data", "{ examplesDropdownOpen: false }"), Class("hidden md:block"),
									Div(Class("ml-10 flex items-baseline space-x-4"),
										A(Href("/app/dashboard"), Class("px-3 py-2 text-sm font-medium text-gray-100 hover:text-white"), Text("Dashboard")),
										...
										A(Href("/app/api-demo"), Class("px-3 py-2 text-sm font-medium text-gray-100 hover:text-white"), Text("API Demo")),
									),
								),
							),
							Div(Class("hidden md:block"),
								Div(Class("ml-4 flex items-center md:ml-6"),
									Div(Class("relative ml-3"),
										Div(
											Button(Attr("x-on:click", "profileDropdownOpen = !profileDropdownOpen"), Attr("x-on:click.outside", "profileDropdownOpen = false"), Type("button"), Class("relative flex max-w-xs items-center bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800"),
												Span(Class("absolute -inset-1.5")),
												Span(Class("sr-only"), Text("Open user menu")),
												Img(Class("h-8 w-8"), Src("/images/profile_picture.png"), Alt("profile picture")),
											),
										),
							...
							Div(Class("-mr-2 flex md:hidden"),
								Button(Attr("x-on:click", "mobileMenuOpen = !mobileMenuOpen"), Type("button"), Class("relative inline-flex items-center justify-center p-2 text-gray-400 hover:bg-blue-900 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800"),
					...
					Div(Attr("x-show", "mobileMenuOpen"), Attr("x-on:click.outside", "mobileMenuOpen = false"), Attr("x-cloak"), Class("md:hidden"),
						Div(Class("space-y-1 px-2 pb-3 pt-2 sm:px-3"),
							A(Href("/app/dashboard"), Class("block hover:bg-blue-900 px-3 py-2 text-base font-medium text-white"), Text("Dashboard")),
						),
						Div(Class("border-t border-gray-700 pb-3 pt-4"),
							Div(Class("flex items-center px-5"),
								Div(Class("flex-shrink-0"),
									Img(Class("h-10 w-10"), Src("/images/profile_picture.png"), Alt("profile picture")),
								),
								Div(Class("ml-3"),
				...
				Header(Class("bg-white shadow"),
					Div(Class("mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8"),
						H1(Class("text-3xl font-bold tracking-tight text-blue-950 font-serif"), Text(title)),
					),
				),
				Main(
					Div(Class("mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8"),
