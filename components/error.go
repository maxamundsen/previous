		...
		Section(Class("bg-white"),
			Div(Class("py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6"),
				Div(Class("mx-auto max-w-screen-sm text-center"),
					...
					A(Href(pageinfo.INDEX_URL), Class("inline-flex text-white bg-neutral-900 hover:bg-neutral-950 font-medium text-sm px-5 py-2.5 text-center my-4"), Text("Back to Homepage")),
				),
			),
		),
	)
