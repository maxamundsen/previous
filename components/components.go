...
func TestNoTw() Node {
	return Div(InlineStyle("color: blue;"),
		P(InlineStyle("text-align: center;")),
		Button(InlineStyle("padding-top: 10px; padding-bottom: 5px; background: gray;"),
			Text("I am a button using inline styles!"),
		),
		Span(Text("Not blue?")),
		Text("test"),
	)
...
func TWUIButton(children ...Node) Node {
	return Button(
		InlineStyle(`
			me {
				white-space: nowrap;
